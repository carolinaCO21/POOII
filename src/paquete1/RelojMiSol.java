...
public class RelojMiSol {
    ...
    // CONSTRUCTORES
    public RelojMiSol(int horas, int minutos, String modelo) {
    ...
    public RelojMiSol(int horas, int minutos) {
        this(horas, minutos, "BASIC-WATCH");
    }

    public RelojMiSol(RelojMiSol reloj) {
        horas = reloj.horas;
    ...
    public static void main(String[] args) {
        RelojMiSol r1 = new RelojMiSol(0, 0);
        RelojMiSol r2 = new RelojMiSol(0, 8);
