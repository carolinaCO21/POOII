...
public class RelojSol {
    ...
    // CONSTRUCTORES
    public RelojSol(int horas, int minutos, String modelo) {
    ...
    public RelojSol(int horas, int minutos) {
        this(horas, minutos, "BASIC-WATCH");
    }

    public RelojSol(RelojSol reloj) {
        horas = reloj.horas;
    ...
    public static void main(String[] args) {
        RelojSol r1 = new RelojSol(17, 1);
        RelojSol r2 = new RelojSol(7, 8);
        r1.en24Horas = r2.en24Horas = false;
        r1.mostrarHora();
        r2.mostrarHora();
        RelojSol r3 = new RelojSol();
        r3.mostrarHora();
