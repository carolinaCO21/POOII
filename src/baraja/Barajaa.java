...
private Carta[] cartasSacadas;
	...
	public Barajaa (int numCartasPalo, String [] losPalos) {
	...
	public static void main(String[] args) {
		...
		Barajaa esp1 = new Barajaa(10, new String [] {"Oros", "Copas", "Espadas", "Bastos"});
		//Otra forma de hacerlo
		String [] misPalos = {"Oros", "Copas", "Espadas", "Bastos"};
		Barajaa esp2 = new Barajaa(10, misPalos);
		for(int i = 0; i< 10; i++) {
